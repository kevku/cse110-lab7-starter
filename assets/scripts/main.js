...
function initFormHandler() {
	...
	formElement.addEventListener('submit', function(event) {
		...
		const recipeLocalStorage = getRecipesFromStorage();
		recipeLocalStorage.push(recipeObject);
		saveRecipesToStorage(recipeLocalStorage);
	});
	...
	clearButton.addEventListener('click', function() {
		localStorage.clear();
		const listOfRecipes = document.querySelectorAll('recipe-card');
		listOfRecipes.forEach(component => {
			component.remove();
		});
	});
